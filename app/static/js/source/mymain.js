...
(function(){
  ...
  function initialize(){
    ...
    $('#searchCommand').click(show_control_panel);
    $('#search_note').click(showSearchOpzioni);
    $('#search_note').click(showSearchOptions);
    ...
    $('#noteWrap').on('click', '.custom_button', updateNote);
    ...
    $('#rollo').click(show_control_panel);
    $('#close_cp').click(close_control_panel);
...
//------animations-------/
  ...
  function show_control_panel(){
    $('#control_panel').fadeToggle(500);
  }

  function close_control_panel(){
    $('#control_panel').fadeOut(500);
  }
...
//-------MostraImmagini&Audio--------------//
  ...
  function showBigPic(){
    ...
    $picture.addClass('bigPic').attr('style', style).css('background-size', 'cover');
...
//-------sort by date/alpha-------//
  ...
  function appendSBD(note){
    ...
    $title.addClass('titleResult').text(note.title.slice(0, 12)).attr('value', note._id);
...
//-------query note-------//
  ...
  function displayNote(data){
    $('.noteTitle, .lollo, .noteData, .noteBody, .noteEdit, .noteTags, .notePicture, .notePicture2, .fullNoteButton').remove();
    data = data.note;
    var $title = $('<div>');
    var $date = $('<div>');
    //var $body = $('<div>');
    ...
    $update.text('Save').addClass('custom_button').addClass('lollo').attr('data-id', data._id).val(data.userId);
    ...
    $fullNote.text('FullNote').addClass('fullNoteButton').addClass('custom_button').attr('href', '/fullNote/'+data._id).val(data.userId);
